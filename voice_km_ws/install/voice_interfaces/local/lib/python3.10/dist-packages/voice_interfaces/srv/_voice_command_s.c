...
bool voice_interfaces__srv__voice_command__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("voice_interfaces.srv._voice_command.VoiceCommand_Request", full_classname_dest, 56) == 0);
  }
  voice_interfaces__srv__VoiceCommand_Request * ros_message = _ros_message;
  {  // command
...
{
  /* NOTE(esteve): Call constructor of VoiceCommand_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("voice_interfaces.srv._voice_command");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VoiceCommand_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool voice_interfaces__srv__voice_command__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("voice_interfaces.srv._voice_command.VoiceCommand_Response", full_classname_dest, 57) == 0);
  }
  voice_interfaces__srv__VoiceCommand_Response * ros_message = _ros_message;
  {  // answer
...
{
  /* NOTE(esteve): Call constructor of VoiceCommand_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("voice_interfaces.srv._voice_command");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VoiceCommand_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
