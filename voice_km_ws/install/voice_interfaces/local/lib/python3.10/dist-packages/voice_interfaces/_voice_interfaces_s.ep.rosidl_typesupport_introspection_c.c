...
static PyMethodDef voice_interfaces__methods[] = {
  {NULL, NULL, 0, NULL}  /* sentinel */
};

static struct PyModuleDef voice_interfaces__module = {
  PyModuleDef_HEAD_INIT,
  "_voice_interfaces_support",
  "_voice_interfaces_doc",
  -1,  /* -1 means that the module keeps state in global variables */
  voice_interfaces__methods,
  NULL,
  NULL,
  NULL,
  NULL,
...
PyMODINIT_FUNC
PyInit_voice_interfaces_s__rosidl_typesupport_introspection_c(void)
{
  PyObject * pymodule = NULL;
  pymodule = PyModule_Create(&voice_interfaces__module);
  if (!pymodule) {
    return NULL;
  }
  int8_t err;
